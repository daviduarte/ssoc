...
class I3Res50(nn.Module):
    ...
    def forward_single(self, x):
        ...
        return x # Quero feature extraction
...
def i3_res50(num_classes):
    ...
    state_dict = torch.load(os.path.join(ROOT_DIR, 'include/extractI3d/pytorch-resnet3d/pretrained/i3d_r50_kinetics.pth'))
    ...
    # uncomment this line when generating I3D from SSOC
    #state_dict = new_dict
